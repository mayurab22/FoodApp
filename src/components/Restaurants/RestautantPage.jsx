...
function RestautantPage() {
  ...
  // Dummy menu items
  const menu = [
    { id: 1, name: "Butter Paneer Masala", price: 300, image: paneer , description:"Delicious blend of soft paneer cheese and green peas in a creamy tomato sauce."},
    { id: 2, name: "Hakka Noodles", price: 200, image: paneer,description:"Delicious blend of soft paneer cheese and green peas in a creamy tomato sauce." },
    { id: 3, name: "Jeera Rice", price: 150, image: paneer,description:"Delicious blend of soft paneer cheese and green peas in a creamy tomato sauce." },
    { id: 4, name: "Mushroom Fried Rice", price: 300, image: paneer,description:"Delicious blend of soft paneer cheese and green peas in a creamy tomato sauce."},
    { id: 5, name: "Dal Tadka", price: 180, image: paneer,description:"Delicious blend of soft paneer cheese and green peas in a creamy tomato sauce." },
    { id: 6, name: "White Sauce Pasta", price: 500, image: paneer,description:"Delicious blend of soft paneer cheese and green peas in a creamy tomato sauce." },
    { id: 7, name: "Laccha Paratha", price: 80, image: paneer,description:"Delicious blend of soft paneer cheese and green peas in a creamy tomato sauce." },
    { id: 8, name: "Vegetable Cheese Sandwich", price: 170, image: paneer,description:"Delicious blend of soft paneer cheese and green peas in a creamy tomato sauce." },
  ];
    ...
    <div>
      ...
      <div className="mx-5 md:p-20">
        ...
        <div className="text-left  leading-8">
          ...
          <p className="text-[#676A6D] flex border-1 w-fit rounded-full pr-3"><svg className="ml-2 mr-2 my-auto" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <circle cx="12" cy="12" r="10" stroke="#CC3333" stroke-width="2" fill="#CC3333"/>
  <line x1="12" y1="6" x2="12" y2="12" stroke="white" stroke-width="2"/>
  <line x1="12" y1="12" x2="16" y2="14" stroke="white" stroke-width="2"/>
</svg>{restaurant.timings}</p> 
{/* Vertical Line */}
<svg className="ml-3 mr-3 invisible md:visible " width="2" height="30" viewBox="0 0 2 100" xmlns="http://www.w3.org/2000/svg">
  <line x1="1" y1="0" x2="1" y2="100" stroke="black" stroke-width="2"/>
</svg>
          <div className="flex">
          <svg className="w-5 h-5 mr-2 my-auto" fill="#CC3333" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21.384,17.752a2.108,2.108,0,0,1-.522,3.359,7.543,7.543,0,0,1-5.476.642C10.5,20.523,3.477,13.5,2.247,8.614a7.543,7.543,0,0,1,.642-5.476,2.108,2.108,0,0,1,3.359-.522L8.333,4.7a2.094,2.094,0,0,1,.445,2.328A3.877,3.877,0,0,1,8,8.2c-2.384,2.384,5.417,10.185,7.8,7.8a3.877,3.877,0,0,1,1.173-.781,2.092,2.092,0,0,1,2.328.445Z"/></svg>
      ...
      <div className="pb-4">
        ...
        <div className="grid grid-cols-1 w-fit mx-auto sm:grid-cols-2 lg:grid-cols-5 gap-6 mt-4">
          {menu.map((item) => (
            ...
            >
              <div className="rounded-md h-30"><img className="object-cover mx-auto rounded-full w-31 h-31" src={item.image}></img></div>
        ...
        {/* Specialties Section */}
        <div className="grid grid-cols-2 mx-auto w-80 md:w-full mt-6 bg-[#AD343E] text-white p-4 rounded-lg sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {specialties.map((item) => (
            <div key={item.name} className="text-center">
              <div className="md:flex mx-auto ">
              <div className="text-4xl p-0"><img className="h-15 w-15 rounded-full mx-auto mt-0" src={item.image}></img></div>
              <p className="mx-auto justify-center font-semibold w-15 md:ml-5 mt-0">{item.name}</p>
            </div>
            </div>
          ))}
        </div>
